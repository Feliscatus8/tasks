...
import com.crud.tasks.trello.client.*;
...
class TrelloControllerTest {
    ...
    public void shouldFetchTrelloBoards() throws Exception {
        ...
        List<TrelloBoardDto> trelloBpards = List.of(new TrelloBoardDto("1", "Test Task", trelloLists));

        when(trelloFacade.fetchTrelloBoards()).thenReturn(trelloBpards);
